  ...
  return (
    <div
      className={cn(
        ...
        "border border-t-0 border-stone-600/30",
        "rounded-b-lg",
                    ...
                    >
                        <div className="flex items-center justify-between w-full">
                            {selectedAdapter ? (
                                ...
                                <span className="text-muted-foreground capitalize">Select {label.toLowerCase()} adapter</span>
                            )}
                        </div>
    ...
    <section className="w-full px-4 md:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl text-primary font-semibold mt-6 mb-1 text-pretty">
            Connect Your Favorite Cloud Services
          </h2>
          <p className="max-w-2xl mx-auto">
            Sync works seamlessly with a growing ecosystem of cloud providers. More integrations coming soon.
          </p>
        </div>

        <div className='w-full flex items-center max-w-5xl gap-x-6 mx-auto  justify-evenly'>
