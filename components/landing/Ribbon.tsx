...
function Ribbon({
  ...
  return (
    <div className='fixed z-50 shadow left-0 top-0 font-[500] bg-primary overflow-hidden h-9 text-black/60 flex items-center justify-center w-full'>
        <div className="h-full w-full absolute opacity-50 -z-10 bg-[radial-gradient(circle_at_center,_rgba(124,58,237,0.4),_transparent_70%)]">
        </div>
        <CTAText 
            createdAt={createdAt} 
