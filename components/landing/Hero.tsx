...
function HeroContent(){
  return (
    <div className='flex flex-col items-center'>
      <div>
        <h1 className='text-2xl lg:text-3xl xl:text-6xl font-semibold'>Move Data Across Clouds</h1>
        <div className='
          flex 
          items-center 
          justify-center 
      ...
      <p className='
        ...
        mt-5 
        text-lg
      '>Sync lets you migrate files between Google Drive, Dropbox, S3 and more —
        with zero data loss, real-time streaming, and background orchestration.
      </p>
    </div>
  )
}
...
function ScatteredAdapters(){
  return (
    <div className='w-full -z-50  h-full absolute left-0 top-0'>
      <Adapter 
        imageUrl='/icons/drive.svg'
        className='left-5 top-10 -rotate-5'
      />
      <Adapter 
        imageUrl='/icons/dropbox.svg'
        className='left-1/2 -bottom-20 ml-5 -rotate-10'
      />
      <Adapter
        imageUrl="/icons/google-photos.svg"
        className="bottom-0 left-1/4 -rotate-12"
      />
      <Adapter 
        imageUrl='/icons/icloud.svg'
        className='right-5 top-10 rotate-5'
      />
      <Adapter 
        imageUrl='/icons/s3.svg'
        className='right-1/2 -bottom-20 mr-5 rotate-10'
      />
      <Adapter
        imageUrl="/icons/onedrive.svg"
        className="bottom-0 right-1/4 rotate-12"
      />
    </div>
  )
}
